<div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
    <div class="my-auto">
        <h5 class="page-title fs-21 mb-1">Penyimpanan</h5>
        <nav>
    ...
    <div class="d-flex my-xl-auto right-content align-items-center">
        <div class="pe-1 mb-xl-0">
            <button type="button" class="btn btn-dark me-2 btn-b btnAdd"><i class="mdi mdi-plus-circle"></i> Tambah Penyimpanan</button>
        </div>
    </div>
</div>
                ...
                <div class="table-responsive">
                    <table class="table" id="my_datatable">
                        ...
                        <tbody>
                            <?php
                            $no=1;
                            $tampil=mysqli_query($conn,"SELECT a.*, b.nama AS nama_cabang FROM master_gudang a
                            LEFT JOIN master_cabang b ON a.master_cabang_id=b.id
...
if(isset($_GET['message'])){
    if($_GET['message']=='add'){
        $pesan = "Berhasil menambahkan data gudang";
    }
    else if($_GET['message']=='edit'){
        $pesan = "Berhasil memperbaharui data gudang";
    }
    else if($_GET['message']=='delete'){
        $pesan = "Berhasil menghapus data gudang";
    }
    ?>
