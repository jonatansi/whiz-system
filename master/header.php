                ...
                <ul class="main-header-dropdown dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu" aria-labelledby="mainHeaderProfile">
                    <li>
                        <div class="main-header-profile bg-primary menu-header-content text-fixed-white">
                            <div class="my-auto">
                                <h6 class="mb-0 lh-1 text-fixed-white"><?php echo $pegawai['nama'];?></h6><span class="fs-11 op-7 lh-1"><?php echo $pegawai['email'];?></span>
                            </div>
                        </div>
                    </li>
                    <li><a class="dropdown-item d-flex" href="profile"><i class="bx bx-user-circle fs-18 me-2 op-7"></i>Profile</a></li>
                    <li><a class="dropdown-item d-flex" href="ubah-password"><i class="bx bx-lock fs-18 me-2 op-7"></i>Ubah Password</a></li>
                    <li><a class="dropdown-item d-flex" href="keluar"><i class="bx bx-log-out fs-18 me-2 op-7"></i>Sign Out</a></li>
                </ul>
            </div>  
            <!-- End::header-element -->
