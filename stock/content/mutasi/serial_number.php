...
(SELECT COUNT(f.id) FROM mutasi_sn f WHERE a.id=f.mutasi_detail_id) AS total_sn 
    ...
    <div class="col-md-12">
        <div class="card">
                    ...
                    <div class="col-md-12">
                        ...
                        <fieldset class="mb-3">
                            ...
                            <form method="POST" action="mutasi-sn-input">
                                <input type="hidden" name="mutasi_detail_id" value="<?php echo $_GET['id'];?>">
                                <div class="row">
                            ...
                            <div class="table table-responsive">
                                <table class="table table-sm" id="my_datatable">
                                    ...
                                    <tbody>
                                        <?php
                                        $no=1;
                                        $tampil=mysqli_query($conn,"SELECT a.*, b.harga FROM mutasi_sn a INNER JOIN material_sn b ON a.material_sn_id=b.id WHERE a.mutasi_detail_id='$_GET[id]'");
            ...
            <div class="card-footer">
                <a href="mutasi-view-<?php echo $mutasi_id;?>" class="btn btn-dark">Kembali</a>
            </div>
        </div>
    </div>
</div>
...
<?php
echo generate_javascript_action("btnDelete", "mutasi-sn-delete");
