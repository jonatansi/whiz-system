<form action="guna-input-material" method="POST" enctype="multipart/form-data" id="form_crud">
    ...
    $("#form_crud").submit(function(e) {
        ...
        performAjaxRequest(actionUrl, form.serialize(), function(msg) {
            if(msg==''){
                ...
                performAjaxRequest('guna-table-material-add', {}, function(msg) {
