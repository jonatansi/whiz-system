<?php
$d=mysqli_fetch_array(mysqli_query($conn,"SELECT a.*, b.nama AS nama_cabang, c.nama AS nama_gudang, d.nama AS nama_status, d.warna AS warna_status, (SELECT SUM(e.jumlah) FROM guna_detail e WHERE a.id=e.guna_id AND e.deleted_at IS NULL) AS total_item, e.nama AS request_pegawai_nama
FROM guna a 
	...
	<body>
        ...
        <table class="border">
            ...
            <tbody class="border">
                <?php
                $no=1;
                $tampil=mysqli_query($conn,"SELECT a.*, b.merk_type, c.nama AS nama_kategori_material, e.nama AS nama_satuan_kecil, f.nama AS nama_gudang, g.nama AS nama_kondisi FROM guna_detail a
                ...
                WHERE a.deleted_at IS NULL AND a.guna_id='$_GET[id]'");
                $grand_total=0;
                while($r=mysqli_fetch_array($tampil)){
                    ...
                    <tr>
                        ...
                        <td><a href="guna-sn-<?php echo $r['id'];?>" target="_blank"><?php echo $r['merk_type'];?></a></td>
