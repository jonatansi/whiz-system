		...
		<div class="modal-content">
			...
			<div class="modal-body" id="form-data">
                <div class="form-group">
                    <label class="mb-2">User Identity <span class="text-danger">*</span></label>
                    <select name="master_guna_kategori_id" class="form-control select2" required  style="width:100%">
                     <?php
                        $tampil=mysqli_query($conn, "SELECT master_guna_kategori_id, user_identity FROM material_sn  WHERE user_identity IS NOT NULL AND master_klasifikasi_material_id='1' AND status_id='505' GROUP BY master_guna_kategori_id, user_identity ORDER BY user_identity");
                        while($r=mysqli_fetch_array($tampil)){
                            echo "<option value='$r[master_guna_kategori_id]|$r[user_identity]'>$r[user_identity]</option>";
                        }
                        ?>
                    </select>
                </div>
