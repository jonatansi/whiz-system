                        ...
                        <fieldset>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <select name="master_gudang_id" class="form-control select2" id="master_gudang_asal_id" required>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="text" class="form-control rupiah" name="jumlah" required placeholder="Jumlah Aktual">
                                        </div>
                                        <div class="col-md-6">
    ...
    $("#form_crud").submit(function(e) {
        ...
        performAjaxRequest(actionUrl, form.serialize(), function(msg) {
            if(msg==''){
                ...
                performAjaxRequest('opname-table-material-add', {}, function(msg) {
